...
async def generate_compliance_report(city: str = Query(default="Delhi")):
    ...
    report = {
        ...
        "generated_by": "Pavan AI Platform",
        ...
        "disclaimer": "This report is auto-generated by Pavan AI platform for decision support. Official compliance reporting should follow CPCB/SPCB prescribed formats.",
    }
